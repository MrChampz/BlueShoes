...
/**
 * Uma implementação de [ItemDetails][ItemDetailsLookup.ItemDetails] fornece à biblioteca
 * de seleção acesso a informações sobre um específico item do RecyclerView. Esta classe
 * é um componente chave no controle dos comportamentos da biblioteca de seleção no
 * contexto de uma atividade específica.
 */
