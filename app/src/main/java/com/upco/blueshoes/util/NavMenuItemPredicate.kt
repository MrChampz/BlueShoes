...
import com.upco.blueshoes.view.MainActivity
import com.upco.blueshoes.data.NavMenuItemsDatabase

/**
 * [SelectionPredicate][SelectionTracker.SelectionPredicate] é utilizada para definir
 * quais itens poderão ser selecionados e quantos deles.
 *
 * A parametrização deve ser do tipo da chave estável definida em ItemKeyProvider.
 */
